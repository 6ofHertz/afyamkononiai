...
import { contactImages } from "@/lib/slideshow-images";
...
const Contact = () => {
  ...
  return (
    <BackgroundSlideshow images={contactImages}>
        ...
        <main className="flex-1 py-16">
          <div className="container max-w-screen-xl px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="bg-card/90 backdrop-blur-sm p-6 rounded-lg border border-border">
              ...
              <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg p-6 shadow-sm">
